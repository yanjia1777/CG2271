...
const char* ssid = "LAPTOP-PLPLNI3L 7241";
const char* password = "jinxjinx";
...
// If disconnected, try to reconnect every 30 seconds.
  ...
  if(req.indexOf("leftForward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "LEFT FORWARD";
    Serial2.write(0x40);
  }
  if(req.indexOf("leftBackward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "LEFT BACKWARD";
    Serial2.write(0x41);
  }
    if(req.indexOf("rightForward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "RIGHT FORWARD";
    Serial2.write(0x42);
  }
  if(req.indexOf("rightBackward") != -1)
  {
    digitalWrite(output26, HIGH);
    ...
    if(req.indexOf("leftFForward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "LEFT FAST FORWARD";
    Serial2.write(0x44);
  }
  if(req.indexOf("leftFBackward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "LEFT FAST BACKWARD";
    Serial2.write(0x45);
  }
    if(req.indexOf("rightFForward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "RIGHT FAST FORWARD";
    Serial2.write(0x46);
  }
  if(req.indexOf("rightFBackward") != -1)
  {
    digitalWrite(output26, HIGH);
    response = "RIGHT FAST BACKWARD";
    Serial2.write(0x47);
  }
